...
class _signupPageState extends State<signupPage> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text('Sign Up',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold,color: Colors.black54,),),
                    ...
                    child: RichText(
                      text: TextSpan(
                          children: <TextSpan>[
                            ...
                            TextSpan(
                                text: " terms of use",
                                style: TextStyle(color: Color(0xFFEA3B4A),fontSize: 16,fontWeight: FontWeight.w500,)
                            ),
                            TextSpan(
                                text: " and our",
                                style: TextStyle(color: Colors.black54,fontSize: 16,fontWeight: FontWeight.w500,)
            ...
            Container(
              ...
              child: Text('Or sign up with:',style: TextStyle(color: Colors.black54,fontSize: 14,fontWeight: FontWeight.w500,),),
            ),
            Container(
  ...
  void createUser() async{
    dynamic result = await _auth.creatNewUser(_nameController.text,_emailController.text,_passwordController.text);
    if(result == null){
